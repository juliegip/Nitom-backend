...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Category: Attribute.Enumeration<
      ['Partenaires', 'Promotions', 'Innovations', 'Massey Ferguson', 'Motin']
    > &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiBandeauBandeau extends Schema.CollectionType {
  collectionName: 'bandeaus';
  info: {
    singularName: 'bandeau';
    pluralName: 'bandeaus';
    displayName: 'Bandeau';
  };
  options: {
  ...
  attributes: {
    ...
    Debut_affichage: Attribute.Date;
    Fin_affichage: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRecrutementRecrutement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contract_type: Attribute.Enumeration<
      ['CDI', 'CDD', 'Interim', 'Alternance', 'Stage']
    > &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::bandeau.bandeau': ApiBandeauBandeau;
